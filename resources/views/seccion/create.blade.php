...
@section('contenido')
    <div class="container mt-4">
        <h1 class="mb-4">Nueva Sección</h1>
        <form method="POST" action="{{ route('seccion.store') }}">
            ...
            <div class="form-row mb-3">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control @error('nombre_seccion') is-invalid @enderror" id="nombre_seccion" name="nombre_seccion" value="{{ old('nombre_seccion') }}">
