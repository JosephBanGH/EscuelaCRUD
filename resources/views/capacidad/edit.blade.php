...
@section('contenido')
    <div class="container mt-4">
        <h1 class="mb-4">Editar Capacidad</h1>
        <form method="POST" action="{{ route('capacidad.update', $capacidad->id_orden) }}">
            @method('PUT')
            @csrf
            ...
            <div class="form-row mb-3">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control @error('descripcion') is-invalid @enderror" id="descripcion" name="descripcion" value="{{ old('descripcion', $capacidad->descripcion) }}">
                    @error('descripcion')
            ...
            <div class="form-row mb-3">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control @error('abreviatura') is-invalid @enderror" id="abreviatura" name="abreviatura" value="{{ old('abreviatura', $capacidad->abreviatura) }}">
                    @error('abreviatura')
                        <div class="invalid-feedback">
                            <strong>{{ $message }}</strong>
                        </div>
